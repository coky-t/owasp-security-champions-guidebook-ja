...
ある金融機関 (銀行) がセキュリティチャンピオンプログラムを正式化するケースを構築するために使用した [こちらの成果物](https://raw.githubusercontent.com/OWASP/Security-Champions/refs/heads/main/docs/assets/artefacts/security%20champions%20(updated).pptx) をご覧ください。
